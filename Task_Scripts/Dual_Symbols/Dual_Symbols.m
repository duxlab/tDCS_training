...
if stand_alone == 1
    ...
    Colour_order = input('Symbols order? 1, 2, or 3?   ');
    ...
    Colour_order = ActiveData(1,5);
    Sound_order = ActiveData(1,6);
...
filename = strcat('Dual_Task_Training_SYMBOLS_PREPOST_SubjectNumber_',num2str(subject_number),'_SessionNumber_',num2str(SessionNumber),'.txt'); 
mat_filename = strcat('Dual_Task_Training_SYMBOLS_PREPOST_SubjectNumber_',num2str(subject_number),'_SessionNumber_',num2str(SessionNumber),'.txt');
...
wavfile1 = 'FinSound_5_200ms.wav';
wavfile2 = 'FinSound_6_200ms.wav';
wavfile3 = 'FinSound_7_200ms.wav';
...
while Phase_exp<=4
   ...
   if Phase_exp==1
       Instruct1 = 'Dual Symbols - Wait for Experiment Instructions. Sounds practice.'; DrawFormattedText(expWin, Instruct1, 'center', 'center'); Screen('Flip', expWin); WaitSecs(2); KbWait(); 
   elseif Phase_exp==2
       Instruct1 = 'Symbols practice, press any key to begin.'; DrawFormattedText(expWin, Instruct1, 'center', 'center'); Screen('Flip', expWin); WaitSecs(2); KbWait(); 
   elseif Phase_exp==3
       Instruct1 = 'Sounds and symbols practice, press any key to begin.'; DrawFormattedText(expWin, Instruct1, 'center', 'center'); Screen('Flip', expWin); WaitSecs(2); KbWait(); 
   elseif Phase_exp==4
 ...
 if Phase_exp>1
        ...
        DrawFormattedText(expWin, Colour_1, (xCenter-220), (yCenter+100));
        DrawFormattedText(expWin, Colour_2, 'center' , (yCenter+100));
        DrawFormattedText(expWin, Colour_3, (xCenter+180), (yCenter+100));
 ...
 while m <= NumOfTrials
    ...
    elseif Trial_Type==2; % colour only
        DrawFormattedText(expWin, Trial_Colour, 'center', 'center'); Screen('Flip', expWin); ColourOnset=GetSecs; ColourOffset=ColourOnset+0.2;
    ...
    while ((GetSecs-Stim2Onset)<= StimPresDuration) 
...
if Hand==1
 ...
 if Phase_exp<=3
     ...
     if acC==1; TextToShow='Symbol CORRECT'; DrawFormattedText(expWin, TextToShow, 'center', (yCenter-110));
        elseif acC==0; TextToShow='Symbol WRONG'; DrawFormattedText(expWin, TextToShow, 'center', (yCenter-110));
        elseif acC==99
     end
...
b=b+1;
    ...
    elseif Phase_exp == 3 %end of last prac
        ...
        Wording2 = strcat('Accuracy for the single task symbols:',num2str(PercentSingleColours));
    ...
    elseif Phase_exp == 4
        ...
        Wording2 = strcat('Single task symbols acuracy: ',num2str(PercentSingleColours),' and reaction time: ',num2str(MeanRTSingleColours));
