...
subject_numbers = [1:12,14:16,21,23,25:43,45:48,50:52,54:58,60:69,71:81,83:118,120:129,131:136,138:140,142,144,146:148,150:165,168,170,171,173:179,182:193,195:203,206,207]; % subject numbers to analyse
...
%                 full_data_matrix(data_matrix_count,1:size(data_matrix,2),analysed_subj_counter) = data_matrix;
             ...
             VS_SS8_AC(subject_count,session_count) = mean(AccuracySS8((subject_count),:));
             VS_SS12_AC(subject_count,session_count) = mean(AccuracySS12((subject_count),:));
             VS_SS16_AC(subject_count,session_count) = mean(AccuracySS16((subject_count),:));
                ...
                elseif condition == 3
                   ...
                   Y=size(BASICDataRTss16); NumDataPoints=Y(2);
                    ...
                    for Cycle = 1:NumDataPoints
                     ...
                     if condition == 1
                         VS_SS8_RT(subject_count,session_count) = nanmean(RTCroppedss8(subject_count,:));
                     elseif condition == 2
                         VS_SS12_RT(subject_count,session_count) = nanmean(RTCroppedss12(subject_count,:));
                     elseif condition == 3
                         VS_SS16_RT(subject_count,session_count) = nanmean(RTCroppedss16(subject_count,:));
                     end;
